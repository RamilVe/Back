        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommentHead = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_roomServicePivots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_roomServicePivots_rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_roomServicePivots_roomServices_RoomServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_roomServicePivots_RoomId",
                table: "roomServicePivots",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_roomServicePivots_RoomServiceId",
                table: "roomServicePivots",
